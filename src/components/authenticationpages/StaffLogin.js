...
import staffAvator from "../../assets/img/avatar.svg";
import staffBackground from "../../assets/img/bg.png";
import staffLogo from "../../assets/img/doctor2.svg"
...
function StaffLogin() {
    ...
    return (
        <div>
            <img className="wave" src={staffBackground} alt='wave'/>
                <div className="container">
                    ...
                    <div className="login-content">
                        <form onSubmit={handleSubmit}>
                            <img src={staffAvator} alt='avatar'/>
